...
public class Boss1HpDisplay extends UiItem {
    public Boss1 boss;
    ...
    public Boss1HpDisplay(String name, int x, int y, int width, int height) {
    ...
    public void draw(Graphics2D g) {
        ...
        g.setFont(font);
        g.drawString("Noxis, the Void-Weaver", BossUiPosX, BossUiPosY - fontSize);
    }

    @Override
    public void onCreate() {
        super.onCreate();
        boss = GameUniverse.getObjectByName("ArtilleryBoss", Boss1.class);
    }
