...
public class Level3LoaderScript extends ScriptSheet implements InputListener {
    ...
    public void onCreate(){
        ...
        GameUniverse.loadImage("AAA", "res/Boss 3/abc.png");
        ...
        run.createAnimationSheet(new Vector2D(1024, 1024), "res/Boss 3/Dash/IMG_4189.png");
        run.setSpeed(10);
        run.setEnabled(true);
        level1Boss.addAnimator("samurun", run);
        Animator yeen=GameUniverse.createInstance(new Animator("sumumairun"));
        yeen.createAnimationSheet(new Vector2D(1024, 1024), "res/Boss 3/IMG_4188.png");
        yeen.setSpeed(10);
        yeen.setEnabled(true);
        level1Boss.addAnimator("samumairun",yeen) ;
        Animator nomal=GameUniverse.createInstance(new Animator("nomalatk"));
        nomal.createAnimationSheet(new Vector2D(1024, 1024), "res/Boss 3/nomal.png");
        nomal.setSpeed(10);
